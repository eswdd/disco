...
package uk.co.exemel.disco.disco.netutil.nio.monitoring;
...
import uk.co.exemel.disco.netutil.nio.monitoring.HostWriteQueueMonitor;
...
public class SessionWriteQueueMonitoringTest {
    ...
    public void twoSessionsSameHostMonitoring() throws Exception {
        ...
        Assert.assertEquals(6, ((HostWriteQueueMonitor) monitorCaptor.getAllValues().get(1)).getTotalWriteQueueDepth());
