...
public class DiscoProtocolTest {
    ...
    private IDiscoProtocol client;
    private IDiscoProtocol server;
    ...
    private void setupProtocol(byte clientVersion, SSLFilter clientSslFilter, boolean clientSupportsTls, boolean clientRequiresTls,
        ...
        if (clientVersion == DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC) {
            if (clientSupportsTls) {
                throw new IllegalArgumentException("Server version doesn't support TLS");
            }
            client = new DiscoProtocol1(false, logger, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC, 2000, 5000);
        } else if (clientVersion == DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC) {
            if (clientSupportsTls) {
                throw new IllegalArgumentException("Server version doesn't support TLS");
            }
            client = new DiscoProtocol2(false, logger, 2000, 5000);
        } else if (clientVersion == DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS) {
            client = new DiscoProtocol3(false, logger, 2000, 5000, clientSslFilter, clientSupportsTls, clientRequiresTls, 0);
        } else if (clientVersion == DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_TIME_CONSTRAINTS) {
            client = new DiscoProtocol4(false, logger, 2000, 5000, clientSslFilter, clientSupportsTls, clientRequiresTls, 0);
        } else if (clientVersion == DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_COMPOUND_REQUEST_UUID) {
            client = new DiscoProtocol5(false, logger, 2000, 5000, clientSslFilter, clientSupportsTls, clientRequiresTls, 0);
        } else {
            throw new IllegalArgumentException("Unsupported client version: " + clientVersion);
        }
        if (serverVersion == DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC) {
            if (serverSupportsTls) {
                throw new IllegalArgumentException("Server version doesn't support TLS");
            }
            server = new DiscoProtocol1(true, logger, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC, 2000, 5000);
        } else if (serverVersion == DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC) {
            if (serverSupportsTls) {
                throw new IllegalArgumentException("Server version doesn't support TLS");
            }
            server = new DiscoProtocol2(true, logger, 2000, 5000);
        } else if (serverVersion == DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS) {
            server = new DiscoProtocol3(true, logger, 2000, 5000, serverSslFilter, serverSupportsTls, serverRequiresTls, 0);
        } else if (serverVersion == DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_TIME_CONSTRAINTS) {
            server = new DiscoProtocol4(true, logger, 2000, 5000, serverSslFilter, serverSupportsTls, serverRequiresTls, 0);
        } else if (serverVersion == DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_COMPOUND_REQUEST_UUID) {
            server = new DiscoProtocol5(true, logger, 2000, 5000, serverSslFilter, serverSupportsTls, serverRequiresTls, 0);
        } else {
            throw new IllegalArgumentException("Unsupported client version: " + clientVersion);
        }
    ...
    public void versionMismatchVNPlusOneOnly_VN() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_MAX_SUPPORTED, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_MAX_SUPPORTED);
    ...
    public void successfulHandshakePlaintextV3_V3() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS);
        ...
        assertEquals(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, clientSession.getAttribute(DiscoProtocol.PROTOCOL_VERSION_ATTR_NAME));
        assertEquals(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, serverSession.getAttribute(DiscoProtocol.PROTOCOL_VERSION_ATTR_NAME));
    }

    @Test
    public void successfulHandshakePlaintextV3_V2() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC);
        ...
        assertEquals(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC, clientSession.getAttribute(DiscoProtocol.PROTOCOL_VERSION_ATTR_NAME));
        assertEquals(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC, serverSession.getAttribute(DiscoProtocol.PROTOCOL_VERSION_ATTR_NAME));
    }

    @Test
    public void successfulHandshakePlaintextV3_V1() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC);
        ...
        assertEquals(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC, clientSession.getAttribute(DiscoProtocol.PROTOCOL_VERSION_ATTR_NAME));
    }

    @Test
    public void successfulHandshakeV2_V3() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS);
    ...
    public void successfulHandshakeV2_V2() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC);
    ...
    public void successfulHandshakeV2_V1() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC);
    ...
    public void successfulHandshakeV1_V3() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS);
        ...
        assertEquals(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC, serverSession.getAttribute(DiscoProtocol.PROTOCOL_VERSION_ATTR_NAME));
    }

    @Test
    public void successfulHandshakeV1_V2() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC, DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC);
    ...
    public void clientRequiresTlsServerTooOldV3_V2() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, sslFilter, true,
                      DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC, null, false);
    ...
    public void clientRequiresTlsServerTooOldV3_V1() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, sslFilter, true,
                DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC, null, false);
    ...
    public void clientTooOldServerRequiresTlsV2_V3() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_BIDIRECTION_RPC, null, false,
                DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, sslFilter, true);
    ...
    public void clientTooOldServerRequiresTlsV1_V3() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_CLIENT_ONLY_RPC, null, false,
                DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, sslFilter, true);
    ...
    public void clientRequiresTlsServerDoesntSupportTlsV3_V3() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, sslFilter, true,
                DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, null, false);
    ...
    public void clientRequiresTlsServerSupportsTlsV3_V3() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, sslFilter, true,
                DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, sslFilter, false);
        ...
        assertEquals(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, clientSession.getAttribute(DiscoProtocol.PROTOCOL_VERSION_ATTR_NAME));
        assertEquals(TLSResult.SSL, clientSession.getAttribute(DiscoProtocol.NEGOTIATED_TLS_LEVEL_ATTR_NAME));
        assertEquals(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, serverSession.getAttribute(DiscoProtocol.PROTOCOL_VERSION_ATTR_NAME));
        assertEquals(TLSResult.SSL, serverSession.getAttribute(DiscoProtocol.NEGOTIATED_TLS_LEVEL_ATTR_NAME));
    }
    ...
    public void clientSupportsTlsServerDoesntSupportTlsV3_V3() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, sslFilter, false,
                DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, null, false);
        ...
        assertEquals(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, clientSession.getAttribute(DiscoProtocol.PROTOCOL_VERSION_ATTR_NAME));
        assertEquals(TLSResult.PLAINTEXT, clientSession.getAttribute(DiscoProtocol.NEGOTIATED_TLS_LEVEL_ATTR_NAME));
        assertEquals(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, serverSession.getAttribute(DiscoProtocol.PROTOCOL_VERSION_ATTR_NAME));
        assertEquals(TLSResult.PLAINTEXT, serverSession.getAttribute(DiscoProtocol.NEGOTIATED_TLS_LEVEL_ATTR_NAME));
    }
    ...
    public void clientDoesntSupportTlsServerDoesntSupportTlsV3_V3() throws Exception {
        setupProtocol(DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, null, false,
                DiscoProtocol.TRANSPORT_PROTOCOL_VERSION_START_TLS, null, false);
    ...
    private PseudoIoSessionMock createSession(IDiscoProtocol otherEnd) {
//        when(session.write())
    ...
    private class PseudoIoSessionMock implements IoSession {
        ...
        private IDiscoProtocol otherEnd;
        private Map<String, Object> attributes = new HashMap<String, Object>();
        private PseudoIoSessionMock otherSession;

        private PseudoIoSessionMock(IDiscoProtocol otherEnd) {
