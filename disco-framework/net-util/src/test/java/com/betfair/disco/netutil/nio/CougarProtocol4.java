 ...
 *
 */
public class DiscoProtocol4 extends DiscoProtocol implements IDiscoProtocol {
    ...
    public static void setMaxServerProtocolVersion(byte maxServerProtocolVersion) {
        DiscoProtocol4.maxServerProtocolVersion = maxServerProtocolVersion;
    }

    public static void setMaxClientProtocolVersion(byte maxClientProtocolVersion) {
        DiscoProtocol4.maxClientProtocolVersion = maxClientProtocolVersion;
    }

    public static void setMinServerProtocolVersion(byte minServerProtocolVersion) {
        DiscoProtocol4.minServerProtocolVersion = minServerProtocolVersion;
    }

    public static void setMinClientProtocolVersion(byte minClientProtocolVersion) {
        DiscoProtocol4.minClientProtocolVersion = minClientProtocolVersion;
    }
    ...
    protected DiscoProtocol4(boolean server, NioLogger nioLogger, int keepAliveInterval, int keepAliveTimeout, SSLFilter sslFilter, boolean supportsTls, boolean requiresTls, long rpcTimeoutMillis) {
