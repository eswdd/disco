...
public class LoggingCheckForStartupMessageTestTest {
    ...
    public void doTest() throws Exception {
        ...
        manager.makeRestDiscoHTTPCall(callBean, DiscoMessageProtocolRequestTypeEnum.RESTJSON, DiscoMessageContentTypeEnum.JSON);
...
//        boolean presentInLog = discoHelpers6.checkLogContainsEntryHeaderValue(log, "ContainerAwareExecutionVenue INFO - **** DISCO HAS STARTED *****");
