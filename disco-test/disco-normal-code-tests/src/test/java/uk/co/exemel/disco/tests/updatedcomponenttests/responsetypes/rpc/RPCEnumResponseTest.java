...
/**
 * Test that the Disco service allows to use enumerations in the response (Batched JSON)
 */
public class RPCEnumResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "callWithEnumResponse"),new RequestLogRequirement("2.8", "callWithEnumResponse") );
