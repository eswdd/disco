...
/**
 * Ensure that when a SOAP request is received, Disco can handle the dateTimeMap datatype containing a date with no offset
 */
public class SOAPRequestTypesDateTimeMapNoOffsetSpecifiedTest {
    ...
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 1, (int) 11, (int) 50, (int) 0, (int) 0);
        // Create the date object expected to be returned in the response

        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 1, (int) 12, (int) 50, (int) 0, (int) 0);
