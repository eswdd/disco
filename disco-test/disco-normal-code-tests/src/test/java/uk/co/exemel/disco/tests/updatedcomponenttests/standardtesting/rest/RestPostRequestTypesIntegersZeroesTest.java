...
/**
 * Ensure that Disco can handle Integers in the post body, header params and query params that are zero
 */
public class RestPostRequestTypesIntegersZeroesTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "i32Operation"),new RequestLogRequirement("2.8", "i32Operation"),new RequestLogRequirement("2.8", "i32Operation"),new RequestLogRequirement("2.8", "i32Operation") );
    }
