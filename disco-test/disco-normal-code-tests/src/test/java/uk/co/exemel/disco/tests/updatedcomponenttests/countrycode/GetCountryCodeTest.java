...
public class GetCountryCodeTest {
   ...
   public void getInferedCountry(String host, String value)throws Exception{
    ...
    discoManager.makeRestDiscoHTTPCall(getNewHttpCallBean, DiscoMessageProtocolRequestTypeEnum.RESTJSON, DiscoMessageContentTypeEnum.JSON);
   ...
   // Convert expected response to a JSON object for comparison with JSON actual response
    ...
    HttpResponseBean response = getNewHttpCallBean.getResponseObjectsByEnum(DiscoMessageProtocolResponseTypeEnum.RESTJSONJSON);
