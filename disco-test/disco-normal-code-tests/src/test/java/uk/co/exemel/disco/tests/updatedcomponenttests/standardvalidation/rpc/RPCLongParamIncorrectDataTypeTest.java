...
/**
 * Ensure that Disco returns the correct fault when a  RPC request with Long param  is made with incorrect data type parameter
 */
public class RPCLongParamIncorrectDataTypeTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i64Operation") );
