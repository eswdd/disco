...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed, Disco can handle a List of Simple Type Enums being passed in the Header and Query parameters
 */
public class RestGetRequestTypesParametersListOfSimpleTypeEnumTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManagerBaseline.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "simpleEnumListOperation"),new RequestLogRequirement("2.8", "simpleEnumListOperation"),new RequestLogRequirement("2.8", "simpleEnumListOperation"),new RequestLogRequirement("2.8", "simpleEnumListOperation") );
    }
