...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.doublez.rest;
...
/**
 * Test that the Disco service allows to use double primitive type in the response (REST)
 */
public class RestdoubleResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "doubleSimpleTypeEcho"),new RequestLogRequirement("2.8", "doubleSimpleTypeEcho"),new RequestLogRequirement("2.8", "doubleSimpleTypeEcho"),new RequestLogRequirement("2.8", "doubleSimpleTypeEcho") );
    }
