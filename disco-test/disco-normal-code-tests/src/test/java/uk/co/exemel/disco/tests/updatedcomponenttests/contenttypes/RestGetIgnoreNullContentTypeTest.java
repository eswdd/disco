...
/**
 * Ensure that when a Rest Get is performed against Disco, supplying a null content type, it is correctly processed as the content type is ignored
 */
public class RestGetIgnoreNullContentTypeTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManagerBaseline.makeRestDiscoHTTPCall(httpCallBeanBaseline, DiscoMessageProtocolRequestTypeEnum.REST);
        ...
        HttpResponseBean response7 = httpCallBeanBaseline.getResponseObjectsByEnum(DiscoMessageProtocolResponseTypeEnum.REST);
