...
/**
 * Ensure that when sustained Rest XML post requests are performed against Disco, each request is successfully sent and the XML response to each is correctly handled
 */
public class RestPostSustainedRequestsAssertedXMLXMLTest {
    ...
    public void doTest() throws Exception {
        ...
        RestSustainedPostRequestsJETTTest.RestSustainedPostRequestsTestResultBean executeTest3 = new RestSustainedPostRequestsJETTTest().executeTest(4000, DiscoMessageProtocolRequestTypeEnum.RESTXML, DiscoMessageContentTypeEnum.XML);
