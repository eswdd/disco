...
/**
 * Ensure that when a  SOAP request is received, Disco can correctly handle passing in a Set of Strings for the header Param and query param
 */
public class SOAPRequestTypesRestParamtersSetOfStringsTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager2.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp8, new RequestLogRequirement("2.8", "stringSetOperation") );
    }
