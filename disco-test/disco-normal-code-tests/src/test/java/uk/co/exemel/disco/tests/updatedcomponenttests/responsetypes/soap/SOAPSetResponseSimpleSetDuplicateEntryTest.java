...
/**
 * Ensure that when a SOAP request operation is performed against Disco, passing in a Set with one duplicate entry, it is correctly processed and the correct Set response returned.
 */
