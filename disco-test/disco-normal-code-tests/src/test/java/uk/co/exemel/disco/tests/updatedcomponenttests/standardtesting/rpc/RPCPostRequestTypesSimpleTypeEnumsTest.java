...
/**
 * Ensure that Disco can handle SimpleType Enums in the post body, header params and query params of an RPC request
 */
public class RPCPostRequestTypesSimpleTypeEnumsTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "enumSimpleOperation"),new RequestLogRequirement("2.8", "enumSimpleOperation") );
