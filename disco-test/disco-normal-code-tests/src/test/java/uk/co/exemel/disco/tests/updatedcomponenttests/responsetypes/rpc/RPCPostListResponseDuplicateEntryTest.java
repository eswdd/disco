...
/**
 * Ensure that when a Batched JSON request is performed against Disco, passing a List with a duplicate entry in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
public class RPCPostListResponseDuplicateEntryTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "testSimpleListGet"),new RequestLogRequirement("2.8", "testSimpleListGet") );
