...
public class SOAPVoidMandatoryMissingTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager discoManager7 = DiscoManager.getInstance();
        discoManager7.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp8, new AccessLogRequirement("87.248.113.14", "/BaselineService/v2", "BadRequest") );
    }
