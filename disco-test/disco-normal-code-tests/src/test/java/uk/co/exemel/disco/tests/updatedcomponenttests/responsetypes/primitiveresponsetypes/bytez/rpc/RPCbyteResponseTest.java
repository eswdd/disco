...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.bytez.rpc;
...
/**
 * Test that the Disco service allows to use byte primitive type in the response (Batched JSON)
 */
public class RPCbyteResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "byteSimpleTypeEcho"),new RequestLogRequirement("2.8", "byteSimpleTypeEcho") );
