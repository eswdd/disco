...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.floatz.rpc;
...
/**
 * Test that the Disco service allows to use float primitive type in the response (Batched JSON)
 */
public class RPCfloatResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "floatSimpleTypeEcho"),new RequestLogRequirement("2.8", "floatSimpleTypeEcho") );
