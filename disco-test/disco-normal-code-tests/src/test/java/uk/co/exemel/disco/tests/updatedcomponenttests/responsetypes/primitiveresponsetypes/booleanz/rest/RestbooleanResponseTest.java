...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.booleanz.rest;
...
/**
 * Test that the Disco service allows to use boolean primitive type in the response (REST)
 */
public class RestbooleanResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "boolSimpleTypeEcho"),new RequestLogRequirement("2.8", "boolSimpleTypeEcho"),new RequestLogRequirement("2.8", "boolSimpleTypeEcho"),new RequestLogRequirement("2.8", "boolSimpleTypeEcho") );
    }
