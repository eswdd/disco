...
/**
 * Ensure that Disco can handle the dateTimeMap data type in the post body of a JSON request containing dates with positive offsets large enough to roll the date to the previous day
 */
