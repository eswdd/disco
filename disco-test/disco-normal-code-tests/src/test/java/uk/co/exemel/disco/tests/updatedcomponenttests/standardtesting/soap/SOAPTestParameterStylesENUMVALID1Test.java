...
/**
 * Test that Disco can correctly handle a valid ENUM. In this case HeaderParam is Foo
 */
public class SOAPTestParameterStylesENUMVALID1Test {
    ...
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers5.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<response><message>headerParam=Foo,queryParam=qp1,dateQueryParam="+discoHelpers1.dateInUTC(convertedDate1)+"</message></response>").getBytes())));
