...
/**
 * Ensure that when a Rest (XML/JSON) Post operation is performed, Disco can correctly handle a simple Set with a duplicate entry in the post body
 */
public class RestPostRequestTypesSetSimpleSetDuplicateEntryTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp7, new RequestLogRequirement("2.8", "simpleSetOperation"),new RequestLogRequirement("2.8", "simpleSetOperation"),new RequestLogRequirement("2.8", "simpleSetOperation"),new RequestLogRequirement("2.8", "simpleSetOperation") );
    }
