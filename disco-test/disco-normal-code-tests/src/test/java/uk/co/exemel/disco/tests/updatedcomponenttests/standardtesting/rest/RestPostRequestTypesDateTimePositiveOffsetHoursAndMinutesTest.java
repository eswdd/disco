...
/**
 * Ensure that Disco can handle the dateTime data type in the post body with a positive offset of hours and minutes (0230 = offset by 2 hours 30 minutes)
 */
public class RestPostRequestTypesDateTimePositiveOffsetHoursAndMinutesTest {
    ...
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 1, (int) 13, (int) 20, (int) 0, (int) 435);
