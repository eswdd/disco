...
/**
 * Ensure that when concurrent Rest XML post requests are performed against Disco, each request is successfully sent and the XML response to each is correctly handled
 */
public class RestPostConcurrentRequestsXMLXMLTest {
    ...
    public void doTest() throws Exception {
        ...
        RestConcurrentPostRequestsJETTTest.RestConcurrentPostRequestsTestsResultBean executeTest3 = new RestConcurrentPostRequestsJETTTest().executeTest(10, 400, DiscoMessageProtocolRequestTypeEnum.RESTXML, DiscoMessageContentTypeEnum.XML);
