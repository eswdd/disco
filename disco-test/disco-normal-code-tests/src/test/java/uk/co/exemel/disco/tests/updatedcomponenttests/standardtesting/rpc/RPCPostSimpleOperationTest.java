...
/**
 * Ensure that when a simple RPC Post is performed against Disco, the request is handled correctly
 */
public class RPCPostSimpleOperationTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "testComplexMutator"),new RequestLogRequirement("2.8", "testComplexMutator") );
