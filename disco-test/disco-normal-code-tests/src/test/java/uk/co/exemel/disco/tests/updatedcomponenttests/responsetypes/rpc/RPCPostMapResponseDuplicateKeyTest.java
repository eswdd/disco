...
/**
 * Ensure that when a Batched JSON request is performed against Disco, passing in a Map containing duplicate keys in the post body, it is correctly de-serialized, processed, returned the correct Map response.
 */
public class RPCPostMapResponseDuplicateKeyTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "testSimpleMapGet"),new RequestLogRequirement("2.8", "testSimpleMapGet") );
