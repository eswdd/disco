...
/**
 * Ensure that Disco can handle Simple Type Integers in the post body, header params and query params that are Zeroes
 */
public class RestPostRequestTypesSimpleTypeIntegersZeroesTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "i32SimpleTypeOperation"),new RequestLogRequirement("2.8", "i32SimpleTypeOperation"),new RequestLogRequirement("2.8", "i32SimpleTypeOperation"),new RequestLogRequirement("2.8", "i32SimpleTypeOperation") );
    }
