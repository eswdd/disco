...
/**
 * Ensure that when a Batched JSON request is performed against Disco, requiring  a String post body element, that an empty string is accepted
 */
public class RPCPostPostBodyStringBlankTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "mandatoryParamsOperation"),new RequestLogRequirement("2.8", "mandatoryParamsOperation") );
