...
/**
 * Ensure that when sustained Rest XML post requests are performed against Disco, each request is successfully sent and the JSON response to each is correctly handled
 */
public class RestPostSustainedRequestsAssertedXMLJSONTest {
    ...
    public void doTest() throws Exception {
        ...
        RestSustainedPostRequestsJETTTest.RestSustainedPostRequestsTestResultBean executeTest3 = new RestSustainedPostRequestsJETTTest().executeTest(4000, DiscoMessageProtocolRequestTypeEnum.RESTXML, DiscoMessageContentTypeEnum.JSON);
