...
/**
 * Ensure that Disco can handle the dateTimeList data type in the post body containing dates with a positive offset
 */
public class RestPostRequestTypesDateTimeListPositiveOffset2Test {
    ...
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 2, (int) 1, (int) 13, (int) 50, (int) 0, (int) 435);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 2, (int) 1, (int) 14, (int) 50, (int) 0, (int) 435);
