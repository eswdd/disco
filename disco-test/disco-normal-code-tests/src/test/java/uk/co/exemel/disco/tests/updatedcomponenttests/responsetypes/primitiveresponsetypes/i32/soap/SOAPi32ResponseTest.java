...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.i32.soap;
...
/**
 * Test that the Disco service allows to use i32 primitive type in the response (SOAP)
 */
public class SOAPi32ResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "i32SimpleTypeEcho") );
    }
