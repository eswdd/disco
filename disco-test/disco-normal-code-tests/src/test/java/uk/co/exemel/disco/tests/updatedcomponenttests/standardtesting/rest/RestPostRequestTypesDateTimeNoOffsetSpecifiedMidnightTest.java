...
/**
 * Ensure that Disco can handle the dateTime data type in the post body with no offset specified (and the time set to midnight)
 */
public class RestPostRequestTypesDateTimeNoOffsetSpecifiedMidnightTest {
    ...
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 2, (int) 1, (int) 0, (int) 0, (int) 0, (int) 0);
