...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.doublez.rpc;
...
/**
 * Test that the Disco service allows to use double primitive type in the response (Batched JSON)
 */
public class RPCdoubleResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "doubleSimpleTypeEcho"),new RequestLogRequirement("2.8", "doubleSimpleTypeEcho") );
