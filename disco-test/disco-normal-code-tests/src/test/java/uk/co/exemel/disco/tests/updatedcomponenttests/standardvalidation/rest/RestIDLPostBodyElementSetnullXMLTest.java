...
/**
 * Ensure that Disco returns the correct fault, when a REST XML request contains a null Set body parameter
 */
public class RestIDLPostBodyElementSetnullXMLTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager10.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp9, new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/simpleSetOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/simpleSetOperation", "BadRequest") );
    }
