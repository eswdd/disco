...
/**
 * Ensure that Disco can handle Integers in the post body, header params and query params of an RPC request
 */
public class RPCPostRequestTypesIntegersTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i32Operation"),new RequestLogRequirement("2.8", "i32Operation"),new RequestLogRequirement("2.8", "i32Operation") );
