...
/**
 * Ensure that when a Batched JSON request is performed against Disco, passing in an empty Map in the post body, it is correctly de-serialized, processed, returned the correct Map response.
 */
