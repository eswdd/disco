...
/**
 * Test that the Disco service throws a correct error when invalid value is passed to  byte primitive type parameter (REST)
 */
public class RestbyteInvalidResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyAccessLogEntriesAfterDate(timeStamp, new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/byteEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/byteEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/byteEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/byteEcho", "BadRequest") );
    }
