...
/**
 * Ensure that Disco can handle the dateTime data type in the post body with a positive offset large enough to cause the date to roll to the previous day
 */
public class RestPostRequestTypesDateTimePositiveOffsetRollToPreviousDayTest {
    ...
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2008, (int) 12, (int) 31, (int) 10, (int) 1, (int) 0, (int) 435);
