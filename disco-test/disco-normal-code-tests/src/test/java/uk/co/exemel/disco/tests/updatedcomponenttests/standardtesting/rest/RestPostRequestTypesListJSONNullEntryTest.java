...
/**
 * Ensure that Disco can handle a list with a null entry in the post body from a JSON request
 */
public class RestPostRequestTypesListJSONNullEntryTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp7, new RequestLogRequirement("2.8", "testLargePostQA") );
    }
