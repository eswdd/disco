...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.i64.rpc;
...
/**
 * Test that the Disco service allows to use i64 primitive type in the response (Batched JSON)
 */
public class RPCi64ResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i64SimpleTypeEcho"),new RequestLogRequirement("2.8", "i64SimpleTypeEcho") );
