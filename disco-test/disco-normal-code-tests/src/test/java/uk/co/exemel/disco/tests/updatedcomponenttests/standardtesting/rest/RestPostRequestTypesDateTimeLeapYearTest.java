...
/**
 * Ensure that Disco can handle the dateTime data type in the post body with the date set to February 29th (in a leap year)
 */
public class RestPostRequestTypesDateTimeLeapYearTest {
    ...
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2012, (int) 2, (int) 29, (int) 13, (int) 50, (int) 0, (int) 435);
