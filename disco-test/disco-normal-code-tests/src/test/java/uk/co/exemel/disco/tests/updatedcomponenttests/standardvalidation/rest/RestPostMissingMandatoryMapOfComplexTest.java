...
/**
 * Ensure that the correct fault is returned when, a Rest(JSON/XML) Post operation is performed against Disco, passing a Map of string:complex object in the post body, where the complex object  contained in the map has a mandatory field missing
 */
public class RestPostMissingMandatoryMapOfComplexTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager1.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp7, new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/mapOfComplexOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/mapOfComplexOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/mapOfComplexOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/mapOfComplexOperation", "BadRequest") );
    }
