...
public class RestIDLHeaderParamBooleanMandatoryNotSetAltURLTest {
    ...
    public void doTest() throws Exception {
        ...
        HttpResponseBean response5 = hbean.getResponseObjectsByEnum(DiscoMessageProtocolResponseTypeEnum.RESTXMLXML);
        ...
        HttpResponseBean response7 = hbean.getResponseObjectsByEnum(DiscoMessageProtocolResponseTypeEnum.RESTXMLJSON);
