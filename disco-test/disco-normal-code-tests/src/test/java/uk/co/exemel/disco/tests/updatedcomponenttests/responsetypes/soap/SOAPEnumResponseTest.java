...
/**
 * Test that the Disco service allows to use enumerations in the response (SOAP)
 */
public class SOAPEnumResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "callWithEnumResponse") );
    }
