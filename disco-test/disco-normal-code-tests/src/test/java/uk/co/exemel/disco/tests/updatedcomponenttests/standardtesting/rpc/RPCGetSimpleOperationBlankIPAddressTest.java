...
/**
 * Ensure that Disco correctly processes a Batch of JSON simple gets, with X_IP in the header set to blank
 */
public class RPCGetSimpleOperationBlankIPAddressTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyAccessLogEntriesAfterDate(timeStamp, new AccessLogRequirement("127.0.0.1", "/json-rpc", "Ok") );
    }
