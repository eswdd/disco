...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.doublez.soap;
...
/**
 * Test that the Disco service allows to use double primitive type in the response (SOAP)
 */
public class SOAPdoubleResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "doubleSimpleTypeEcho") );
    }
