...
/**
 * Ensure that when a SOAP request is received, Disco can handle an ENUM datatype parameter. In this case the parameters can be either FOO, BAR or FOOBAR
 */
public class SOAPRequestTypesSimpleTypeEnumsTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager2.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp8, new RequestLogRequirement("2.8", "enumSimpleOperation") );
    }
