...
/**
 * Ensure that Disco can handle ENUMS in the post body, header params and query params
 */
public class RestPostRequestTypesEnumsTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "enumOperation"),new RequestLogRequirement("2.8", "enumOperation"),new RequestLogRequirement("2.8", "enumOperation"),new RequestLogRequirement("2.8", "enumOperation") );
    }
