...
/**
 * Ensure that Disco can handle the dateTimeSet data type with no offets specified in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeSetNoOffsetTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeSetOperation"),new RequestLogRequirement("2.8", "dateTimeSetOperation") );
