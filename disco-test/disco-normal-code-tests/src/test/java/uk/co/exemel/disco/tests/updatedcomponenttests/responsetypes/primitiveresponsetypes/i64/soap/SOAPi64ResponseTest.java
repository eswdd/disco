...
/**
 * Test that the Disco service allows to use i64 primitive type in the response (SOAP)
 */
public class SOAPi64ResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "i64SimpleTypeEcho") );
    }
