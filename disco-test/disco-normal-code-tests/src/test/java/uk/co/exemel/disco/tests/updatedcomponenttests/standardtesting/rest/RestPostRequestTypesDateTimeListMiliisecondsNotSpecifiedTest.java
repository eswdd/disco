...
/**
 * Ensure that Disco can handle the dateTimeList data type in the post body containing dates with no milliseconds specified
 */
public class RestPostRequestTypesDateTimeListMiliisecondsNotSpecifiedTest {
    ...
    public void doTest() throws Exception {
        ...
        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 2, (int) 13, (int) 50, (int) 0, (int) 0);
