...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed, Disco can handle a Set of Strings with a blank entry being passed in the Header and Query parameters
 */
