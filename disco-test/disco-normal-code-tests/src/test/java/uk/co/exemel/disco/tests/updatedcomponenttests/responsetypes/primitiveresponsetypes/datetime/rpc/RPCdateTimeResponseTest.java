...
/**
 * Test that the Disco service allows to use dateTime primitive type in the response (Batched JSON)
 */
public class RPCdateTimeResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho"),new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho") );
