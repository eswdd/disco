...
/**
 * Ensure that when a simple Rest XML/JSON Post is performed against Disco, requesting each supported response protocol (XML/JSON) the request is handled correctly
 */
