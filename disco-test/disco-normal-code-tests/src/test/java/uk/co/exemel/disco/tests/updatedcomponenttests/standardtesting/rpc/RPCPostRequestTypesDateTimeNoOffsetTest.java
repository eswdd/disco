...
/**
 * Ensure that Disco can handle the dateTime data type with no offets specified in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeNoOffsetTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeOperation"),new RequestLogRequirement("2.8", "dateTimeOperation"),new RequestLogRequirement("2.8", "dateTimeOperation") );
