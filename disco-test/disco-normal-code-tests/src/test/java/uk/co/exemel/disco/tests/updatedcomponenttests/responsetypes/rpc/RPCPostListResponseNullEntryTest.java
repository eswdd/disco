...
/**
 * Ensure that when a Batched JSON request is performed against Disco, passing a List with a null entry in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
