...
/**
 * Ensure that when a SOAP request is received, Disco can handle the dateTime datatype with a positive offest that causes the date to roll to the previous day
 */
public class SOAPRequestTypesDateTimePositiveOffSetRollToPreviousDayTest {
    ...
    public void doTest() throws Exception {
        ...
        String convertUTCDateTimeToDiscoFormat6 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2008, (int) 12, (int) 31, (int) 10, (int) 1, (int) 0, (int) 0);
