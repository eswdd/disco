...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.booleanz.soap;
...
/**
 * Test that the Disco service allows to use boolean primitive type in the response (SOAP)
 */
public class SOAPbooleanResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "boolSimpleTypeEcho") );
    }
