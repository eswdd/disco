...
/**
 * Ensure that when a Rest XML Get is performed on Disco, with XML the highest ranked response protocol, the response is XML
 */
public class RestGetAcceptProtocolRankingXMLXMLTest {
    ...
    public void doTest() throws Exception {
        ...
        HttpResponseBean getResponseObjectsByEnum11 = getNewHttpCallBean1.getResponseObjectsByEnum(DiscoMessageProtocolResponseTypeEnum.REST);
