...
public class RestIDLPostBodyElementByteOutOfRangeTest {
    ...
    public void doTest() throws Exception {
        ...
        HttpResponseBean response10 = hbean.getResponseObjectsByEnum(DiscoMessageProtocolResponseTypeEnum.RESTXMLXML);
        ...
        HttpResponseBean response11 = hbean.getResponseObjectsByEnum(DiscoMessageProtocolResponseTypeEnum.RESTJSONJSON);
        ...
        HttpResponseBean response12 = hbean.getResponseObjectsByEnum(DiscoMessageProtocolResponseTypeEnum.RESTXMLJSON);
        ...
        HttpResponseBean response13 = hbean.getResponseObjectsByEnum(DiscoMessageProtocolResponseTypeEnum.RESTJSONXML);
