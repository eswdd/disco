...
/**
 * Ensure that Disco returns the correct fault, when a REST request has a body parameter that contains a date list with dates with the seconds set to 60 (should be rolled to the next minute)
 */
public class RestPostRequestTypesDateTimeList60SecondsTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager9.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp11, new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/dateTimeListOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/dateTimeListOperation", "BadRequest") );
    }
