...
/**
 * Ensure that Disco can handle the dateTime data type with Zero Offsets in the post body of an RPC request
 */
public class RPCPostRequestTypesDateTimeZeroOffsetTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeOperation"),new RequestLogRequirement("2.8", "dateTimeOperation") );
