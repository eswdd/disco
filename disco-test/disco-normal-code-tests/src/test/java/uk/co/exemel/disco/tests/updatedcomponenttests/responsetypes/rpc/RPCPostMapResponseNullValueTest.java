...
/**
 * Ensure that when a Batched JSON request is performed against Disco, passing in a Map with a null value in the post body, it is correctly de-serialized, processed, returned the correct Map response.
 */
