...
/**
 * Ensure that the disco server logs correctly according to the logging level set. (Set level to WARNING)
 */
...
//            Thread.sleep(60000);
            ...
            discoManager1.verifyServiceLogEntriesAfterDate(getTimeAsTimeStamp13,
                    new ServiceLogRequirement("uk.co.exemel.disco.baseline.BaselineServiceImpl WARN - WARN-Log-Message"),
