...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.string.rest;
...
/**
 * Test that the Disco service allows to use string primitive type in the response (REST)
 */
public class ReststringResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "stringSimpleTypeEcho"),new RequestLogRequirement("2.8", "stringSimpleTypeEcho"),new RequestLogRequirement("2.8", "stringSimpleTypeEcho"),new RequestLogRequirement("2.8", "stringSimpleTypeEcho") );
    }
