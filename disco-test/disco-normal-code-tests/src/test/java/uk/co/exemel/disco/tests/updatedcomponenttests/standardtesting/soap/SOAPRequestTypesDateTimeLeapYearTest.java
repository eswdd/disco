...
/**
 * Ensure that when a SOAP request is received, Disco can handle the dateTime datatypewith a date on 29th February (in a  leap year)
 */
public class SOAPRequestTypesDateTimeLeapYearTest {
    ...
    public void doTest() throws Exception {
        ...
        String convertUTCDateTimeToDiscoFormat6 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2012, (int) 2, (int) 29, (int) 13, (int) 50, (int) 0, (int) 0);
