...
/**
 * Ensure that when a Rest (JSON) Post operation is performed against Disco, passing and returning a Map of primitive integers in the post body, it is correctly de-serialized, processed, returned the correct Map response.
 */
