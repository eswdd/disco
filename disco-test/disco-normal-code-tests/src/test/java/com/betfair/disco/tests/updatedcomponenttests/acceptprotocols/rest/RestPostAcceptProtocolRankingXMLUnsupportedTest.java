...
/**
 * Ensure that when a Rest XML Post operation is performed on Disco, with all ranked response protocols being unsupported, the correct error response is generated.
 */
