...
/**
 * Ensure that when a Batched JSON request is made to an operation of Disco, passing a list with a size different to the size stated in the post body, that the correct response message is returned
 */
public class RPCPostPostBodyOutOfOrderTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "testLargePostQA"),new RequestLogRequirement("2.8", "testLargePostQA") );
