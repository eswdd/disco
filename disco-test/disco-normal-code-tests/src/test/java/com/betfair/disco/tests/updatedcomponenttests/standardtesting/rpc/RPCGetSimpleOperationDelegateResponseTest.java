...
/**
 * Ensure that when a Batched JSON simple Get is performed against Disco, the repsonse can be populated using a delegate.
 */
public class RPCGetSimpleOperationDelegateResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "testSimpleGetQA"),new RequestLogRequirement("2.8", "testSimpleGetQA") );
