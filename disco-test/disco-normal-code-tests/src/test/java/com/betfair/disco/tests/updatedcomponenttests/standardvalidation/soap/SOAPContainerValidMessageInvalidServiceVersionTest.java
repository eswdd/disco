...
/**
 * Ensure that Disco returns the correct DSC-0021 fault when a  SOAP request is made to a Version of a Service that doesn't exist. Error should be "Not Found"
 */
public class SOAPContainerValidMessageInvalidServiceVersionTest {
    ...
    public void doTest(boolean schemaValidationEnabled) throws Exception {
        ...
        try {
            ...
            discoManager9.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp9, new AccessLogRequirement("87.248.113.14", "/BaselineService/v0.1", "NotFound"));
        } finally {
