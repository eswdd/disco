...
/**
 * Ensure that Disco can handle the dateTimeList data type in the post body containing dates set to February 29th in a leap year
 */
public class RestPostRequestTypesDateTimeListLeapYearTest {
    ...
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2012, (int) 2, (int) 29, (int) 13, (int) 50, (int) 0, (int) 435);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2012, (int) 2, (int) 29, (int) 13, (int) 51, (int) 0, (int) 435);
