...
/**
 * Ensure that Disco can handle the dateTime data type in the post body with a date with millisecond accuracy
 */
public class RestPostRequestTypesDateTimeMiliisecondsTest {
    ...
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 1, (int) 13, (int) 50, (int) 0, (int) 435);
