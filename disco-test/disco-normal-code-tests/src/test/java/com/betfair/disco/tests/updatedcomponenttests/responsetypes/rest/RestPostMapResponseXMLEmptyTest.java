...
/**
 * Ensure that when a Rest (XML) Post operation is performed against Disco, passing in an empty Map in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
