...
/**
 * Ensure that Disco can handle the dateTimeMap data type in the post body of an XML request containing a date with a negative offset of hours and minutes (0230 = offset by 2 hours 30 minutes)
 */
public class RestPostRequestTypesDateTimeMapXMLNegativeOffsetHoursAndMinutesTest {
    ...
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 1, (int) 14, (int) 20, (int) 0, (int) 435);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 1, (int) 15, (int) 20, (int) 0, (int) 435);
        ...
        hinstance.makeRestDiscoHTTPCall(hbean, com.betfair.testing.utils.disco.enums.DiscoMessageProtocolRequestTypeEnum.RESTXML, com.betfair.testing.utils.disco.enums.DiscoMessageContentTypeEnum.XML);
        // Make XML call to the operation requesting a JSON response
        hinstance.makeRestDiscoHTTPCall(hbean, com.betfair.testing.utils.disco.enums.DiscoMessageProtocolRequestTypeEnum.RESTXML, com.betfair.testing.utils.disco.enums.DiscoMessageContentTypeEnum.JSON);
