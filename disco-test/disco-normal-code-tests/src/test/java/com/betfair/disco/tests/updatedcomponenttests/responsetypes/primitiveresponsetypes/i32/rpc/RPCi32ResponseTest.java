...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.i32.rpc;
...
/**
 * Test that the Disco service allows to use i32 primitive type in the response (Batched JSON)
 */
public class RPCi32ResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "i32SimpleTypeEcho"),new RequestLogRequirement("2.8", "i32SimpleTypeEcho") );
