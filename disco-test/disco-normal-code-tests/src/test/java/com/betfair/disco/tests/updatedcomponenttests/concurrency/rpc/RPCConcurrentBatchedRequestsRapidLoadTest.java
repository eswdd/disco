...
/**
 * Ensure that when concurrent Batched JSON requests are performed against Disco with a rapid load of a large number of threads, each batch of requests is successfully sent and the JSON response to each is correctly handled
 */
