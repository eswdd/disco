...
/**
 * Ensure that Disco can correctly handle a string Query Param containing a space
 */
public class RestGetRequestTypesStringQueryParamEscapedCharactersSpaceTest {
    ...
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers6.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<SimpleResponse><message>headerParam=Foo,queryParam=a space,dateQueryParam="+discoHelpers4.dateInUTC(convertedDate1)+"</message></SimpleResponse>").getBytes())));
