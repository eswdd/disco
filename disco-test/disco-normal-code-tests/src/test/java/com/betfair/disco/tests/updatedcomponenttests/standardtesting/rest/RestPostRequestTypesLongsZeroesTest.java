...
/**
 * Ensure that Disco can handle Longs in the post body, header params and query params which are Zero
 */
public class RestPostRequestTypesLongsZeroesTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "i64Operation"),new RequestLogRequirement("2.8", "i64Operation"),new RequestLogRequirement("2.8", "i64Operation"),new RequestLogRequirement("2.8", "i64Operation") );
    }
