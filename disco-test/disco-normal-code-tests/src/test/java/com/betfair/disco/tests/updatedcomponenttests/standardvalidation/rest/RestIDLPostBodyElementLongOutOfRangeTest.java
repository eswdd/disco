...
/**
 * Ensure that Disco returns the correct fault, when a REST request contains an out of range Long body parameter
 */
public class RestIDLPostBodyElementLongOutOfRangeTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager15.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp11, new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/i64Operation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/i64Operation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/i64Operation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/i64Operation", "BadRequest") );
    }
