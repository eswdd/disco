...
/**
 * Ensure that Disco can handle the dateTime data type in the post body with a negative offset large enough to cause the date to roll to the next day
 */
public class RestPostRequestTypesDateTimeNegativeOffsetRollToNextDayTest {
    ...
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2010, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 435);
