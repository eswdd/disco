...
/**
 * Ensure that Disco can handle the dateTimeMap data type in the post body of an XML request containg a date with milliseconds accuracy
 */
public class RestPostRequestTypesDateTimeMapXMLMillisecondsTest {
    ...
    public void doTest() throws Exception {
        ...
        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 1, (int) 14, (int) 50, (int) 0, (int) 435);
