...
/**
 * Ensure that Disco returns the correct fault, when a REST request contains an out of range value in a Byte body parameter
 */
public class RestIDLPostBodyElementByteOutOfRangeTest {
    ...
    public void doTest() throws Exception {
        ...
        HttpResponseBean response10 = hbean.getResponseObjectsByEnum(com.betfair.testing.utils.disco.enums.DiscoMessageProtocolResponseTypeEnum.RESTXMLXML);
        ...
        HttpResponseBean response11 = hbean.getResponseObjectsByEnum(com.betfair.testing.utils.disco.enums.DiscoMessageProtocolResponseTypeEnum.RESTJSONJSON);
        ...
        HttpResponseBean response12 = hbean.getResponseObjectsByEnum(com.betfair.testing.utils.disco.enums.DiscoMessageProtocolResponseTypeEnum.RESTXMLJSON);
        ...
        HttpResponseBean response13 = hbean.getResponseObjectsByEnum(com.betfair.testing.utils.disco.enums.DiscoMessageProtocolResponseTypeEnum.RESTJSONXML);
