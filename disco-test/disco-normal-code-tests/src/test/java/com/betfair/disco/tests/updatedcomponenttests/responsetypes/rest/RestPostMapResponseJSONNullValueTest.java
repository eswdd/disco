...
/**
 * Ensure that when a Rest (JSON) Post operation is performed against Disco, passing in a Map containing a null value in the post body, it is correctly de-serialized, processed, returned the correct response.
 */
