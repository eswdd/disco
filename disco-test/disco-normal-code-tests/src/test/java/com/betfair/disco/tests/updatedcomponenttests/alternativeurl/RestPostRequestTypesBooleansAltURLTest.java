...
/**
 * Ensure that Disco  can successfully handle a request to the alternative URL exposed by the baseline service (e.g. http://10.2.8.203:8080/www/discoBaseline/v2.8/boolOperation)
 */
public class RestPostRequestTypesBooleansAltURLTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp9, new RequestLogRequirement("2.8", "boolOperation"),new RequestLogRequirement("2.8", "boolOperation"),new RequestLogRequirement("2.8", "boolOperation"),new RequestLogRequirement("2.8", "boolOperation") );
        // Check the correct URL was used
        discoManager1.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp9, new AccessLogRequirement("87.248.113.14", "/www/discoBaseline/v2/boolOperation", "Ok"),new AccessLogRequirement("87.248.113.14", "/www/discoBaseline/v2/boolOperation", "Ok"),new AccessLogRequirement("87.248.113.14", "/www/discoBaseline/v2/boolOperation", "Ok"),new AccessLogRequirement("87.248.113.14", "/www/discoBaseline/v2/boolOperation", "Ok") );
    }
