...
/**
 * Ensure that the correct fault is returned when, a Rest(JSON) Post operation is performed against Disco, passing a Set of complex object in the post body, where the complex object  contained in the set has a mandatory field missing
 */
public class RestPostMissingMandatorySetOfComplexJSONTest {
    ...
    public void doTest() throws Exception {
        ...
        HttpResponseBean response5 = getNewHttpCallBean1.getResponseObjectsByEnum(com.betfair.testing.utils.disco.enums.DiscoMessageProtocolResponseTypeEnum.RESTJSONXML);
        ...
        discoManager1.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp7, new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/setOfComplexOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/setOfComplexOperation", "BadRequest") );
    }
