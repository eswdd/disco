...
/**
 * Ensure that when sustained Rest JSON post requests are performed against Disco, each request is successfully sent and the XML response to each is correctly handled
 */
public class RestPostSustainedRequestsAssertedJSONXMLTest {
    ...
    public void doTest() throws Exception {
        ...
        RestSustainedPostRequestsJETTTest.RestSustainedPostRequestsTestResultBean executeTest3 = new RestSustainedPostRequestsJETTTest().executeTest(4000, DiscoMessageProtocolRequestTypeEnum.RESTJSON, DiscoMessageContentTypeEnum.XML);
