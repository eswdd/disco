...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.datetime.rest;
...
/**
 * Test that the Disco service allows to use dateTime primitive type in the response (REST)
 */
public class RestdateTimeResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho"),new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho"),new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho"),new RequestLogRequirement("2.8", "dateTimeSimpleTypeEcho") );
    }
