...
/**
 * Ensure that Disco returns the correct fault, when a REST request contains a non ENUM as an ENUM body parameter
 */
public class RestIDLPostBodyElementEnumIncorrectDataTypeTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager15.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp11, new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/enumOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/enumOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/enumOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/enumOperation", "BadRequest") );
    }
