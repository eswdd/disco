...
/**
 * Ensure that when a Batched JSON request is performed, Disco can handle a Set of Simple Type Enums being passed in the Header and Query parameters
 */
public class RPCGetRequestTypesParametersSetOfSimpleTypeEnumTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "simpleEnumSetOperation"),new RequestLogRequirement("2.8", "simpleEnumSetOperation") );
