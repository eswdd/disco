...
/**
 * Ensure that Disco can handle Booleans in the post body, header params and query params of an RPC request
 */
public class RPCPostRequestTypesBooleansTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "boolOperation"),new RequestLogRequirement("2.8", "boolOperation") );
