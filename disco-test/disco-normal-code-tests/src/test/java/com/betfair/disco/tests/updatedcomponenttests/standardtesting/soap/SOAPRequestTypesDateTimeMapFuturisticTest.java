...
/**
 * Ensure that when a SOAP request is received, Disco can handle the dateTimeMap datatype containing a date set far in the future
 */
public class SOAPRequestTypesDateTimeMapFuturisticTest {
    ...
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 3009, (int) 6, (int) 1, (int) 13, (int) 50, (int) 0, (int) 0);
        // Create the date objects expected to be returned in the response

        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 3009, (int) 6, (int) 2, (int) 13, (int) 50, (int) 0, (int) 0);
