...
/**
 * Ensure that Disco can handle the dateTime data type in the post body with a negative offset
 */
public class RestPostRequestTypesDateTimeNegativeOffset2Test {
    ...
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 3, (int) 1, (int) 13, (int) 50, (int) 0, (int) 435);
