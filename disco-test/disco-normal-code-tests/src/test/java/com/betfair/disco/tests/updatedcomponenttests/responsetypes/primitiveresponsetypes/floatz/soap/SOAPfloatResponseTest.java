...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.floatz.soap;
...
/**
 * Test that the Disco service allows to use float primitive type in the response (SOAP)
 */
public class SOAPfloatResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyRequestLogEntriesAfterDate(timestamp, new RequestLogRequirement("2.8", "floatSimpleTypeEcho") );
    }
