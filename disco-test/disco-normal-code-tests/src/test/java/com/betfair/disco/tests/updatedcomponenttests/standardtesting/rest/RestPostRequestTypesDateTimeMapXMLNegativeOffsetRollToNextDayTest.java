...
/**
 * Ensure that Disco can handle the dateTimeMap data type in the post body of an XML request with a date with a negative offset large enough to roll the date to the next day
 */
public class RestPostRequestTypesDateTimeMapXMLNegativeOffsetRollToNextDayTest {
    ...
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2010, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 435);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2010, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 436);
