...
/**
 * Ensure that Disco returns the correct fault when a  RPC request with boolean param  is made with incorrect data type parameter
 */
public class RPCBooleanParamIncorrectDataTypeTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "boolOperation") );
