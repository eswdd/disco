...
/**
 * Ensure that Disco can handle the dateTime data type in the post body that specifies the UTC timezone
 */
public class RestPostRequestTypesDateTimeZOffset2Test {
    ...
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 2, (int) 1, (int) 11, (int) 50, (int) 0, (int) 435);
