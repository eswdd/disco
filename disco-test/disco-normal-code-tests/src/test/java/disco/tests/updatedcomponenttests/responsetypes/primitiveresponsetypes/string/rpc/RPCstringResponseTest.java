...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.string.rpc;
...
/**
 * Test that the Disco service allows to use string primitive type in the response (Batched JSON)
 */
public class RPCstringResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "stringSimpleTypeEcho"),new RequestLogRequirement("2.8", "stringSimpleTypeEcho") );
