...
/**
 * Ensure that Disco can correctly handle a string Query Param containing encoded &
 */
public class RestGetRequestTypesStringQueryParamEscapedCharactersAmpersandTest {
    ...
    public void doTest() throws Exception {
        ...
        Document createAsDocument10 = xMLHelpers6.createAsDocument(DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new ByteArrayInputStream(("<SimpleResponse><message>headerParam=Foo,queryParam=this&amp;that,dateQueryParam="+discoHelpers4.dateInUTC(convertedDate1)+"</message></SimpleResponse>").getBytes())));        // Convert the expected response to REST types for comparison with actual responses
