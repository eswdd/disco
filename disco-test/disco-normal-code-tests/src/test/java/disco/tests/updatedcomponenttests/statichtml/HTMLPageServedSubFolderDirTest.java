...
/**
 * Ensure disco can ship static html files: handle basic html from a specified subfolder directory
 */
public class HTMLPageServedSubFolderDirTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager2.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp1, new AccessLogRequirement(null, "/static-html/subfolder/subfoo.html", "Ok") );
    }
