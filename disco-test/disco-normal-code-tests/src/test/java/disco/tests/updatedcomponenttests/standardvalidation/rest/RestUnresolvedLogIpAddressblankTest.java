...
/**
 * Ensure that when Disco cannot resolve a request, the entry written to the unresolved log caters for when the passed X-Forwarded-For header value is blank
 */
