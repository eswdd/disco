...
/**
 * Ensure that when a SOAP request is received, Disco can handle the double datatype with doubles that will be handled as Infinity
 */
public class SOAPRequestTypesDoublesInfinityTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager2.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp7, new RequestLogRequirement("2.8", "doubleOperation") );
    }
