...
/**
 * Ensure that Disco can handle the dateTimeSet data type in the post body with a date with a negative offset with hours and minutes (0230 = offset by 2 hours 30 minutes)
 */
