...
/**
 * Ensure that when a Disco container is running a service, the heathcheck detailed operation returns correct Status Details for each component that has a status set in service. (All OK)
 */
