...
/**
 * Ensure that when a Rest (XML/JSON) Post operation is performed, Disco can correctly handle a complex Set in the post body
 */
public class RestPostRequestTypesSetComplexSetTest {
    ...
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 1, (int) 13, (int) 50, (int) 0, (int) 435);
        // Create date object that will appear in the returned set 

        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 2, (int) 13, (int) 50, (int) 0, (int) 435);
        // Create date object that will appear in the returned set 

        String date3 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 6, (int) 3, (int) 13, (int) 50, (int) 0, (int) 435);
        ...
        HttpResponseBean response8 = getNewHttpCallBean1.getResponseObjectsByEnum(com.betfair.testing.utils.disco.enums.DiscoMessageProtocolResponseTypeEnum.RESTXMLXML);
        ...
        HttpResponseBean response10 = getNewHttpCallBean1.getResponseObjectsByEnum(com.betfair.testing.utils.disco.enums.DiscoMessageProtocolResponseTypeEnum.RESTJSONXML);
        ...
        HttpResponseBean response11 = getNewHttpCallBean1.getResponseObjectsByEnum(com.betfair.testing.utils.disco.enums.DiscoMessageProtocolResponseTypeEnum.RESTJSONJSON);
        ...
        discoManager1.verifyRequestLogEntriesAfterDate(getTimeAsTimeStamp10, new RequestLogRequirement("2.8", "complexSetOperation"),new RequestLogRequirement("2.8", "complexSetOperation"),new RequestLogRequirement("2.8", "complexSetOperation"),new RequestLogRequirement("2.8", "complexSetOperation") );
    }
