...
/**
 * Ensure that when a Batched JSON request is performed against a Disco operation that requires no parameters, the correct response is received.
 */
public class RPCGetNoParametersRequiredTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "testNoParams"),new RequestLogRequirement("2.8", "testNoParams") );
