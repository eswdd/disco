...
/**
 * Ensure that Disco can handle the dateTimeList data type in the post body containing dates with less than 3 digits millisecond accuracy
 */
public class RestPostRequestTypesDateTimeListMiliisecondsFillTo3DigitsTest {
    ...
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 430);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 1, (int) 2, (int) 13, (int) 50, (int) 0, (int) 430);
