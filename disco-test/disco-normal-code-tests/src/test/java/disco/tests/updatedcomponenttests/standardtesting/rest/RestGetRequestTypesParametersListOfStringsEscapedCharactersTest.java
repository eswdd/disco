...
/**
 * Ensure that when the 4 supported Rest XML/JSON Gets are performed, Disco can handle a List of Strings containing escaped characters being passed in the Header and Query parameters
 */
