...
/**
 * Ensure that Disco returns the correct fault, when a REST request contains a body parameter that is a missing a mandatory String field
 */
public class RestIDLPostBodyElementStringMandatoryNotSetTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager13.verifyAccessLogEntriesAfterDate(getTimeAsTimeStamp11, new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/mandatoryParamsOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/mandatoryParamsOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/mandatoryParamsOperation", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/mandatoryParamsOperation", "BadRequest") );
    }
