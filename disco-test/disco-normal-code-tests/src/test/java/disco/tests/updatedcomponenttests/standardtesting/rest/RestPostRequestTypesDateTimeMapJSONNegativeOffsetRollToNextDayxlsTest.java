...
/**
 * Ensure that Disco can handle the dateTimeMap data type in the post body of a JSON request with a date with a negative offset large enough to roll the date to the next day
 */
