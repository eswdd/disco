...
/**
 * Ensure that Disco can handle the dateTime data type in the post body with more than 3 digits millisecond accuracy (round up)
 */
public class RestPostRequestTypesDateTimeMiliisecondsRoundTo3Digits2Test {
    ...
    public void doTest() throws Exception {
        ...
        String date = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 1, (int) 1, (int) 13, (int) 50, (int) 0, (int) 434);
        ...
        Map<DiscoMessageProtocolRequestTypeEnum, Object> expectedREST = discoManager1.convertResponseToRestTypes(expectedXML, getNewHttpCallBean1);
        ...
        AssertionUtils.multiAssertEquals(expectedREST.get(DiscoMessageProtocolRequestTypeEnum.RESTXML), response5.getResponseObject());
        ...
        AssertionUtils.multiAssertEquals(expectedREST.get(DiscoMessageProtocolRequestTypeEnum.RESTJSON), response6.getResponseObject());
        ...
        AssertionUtils.multiAssertEquals(expectedREST.get(DiscoMessageProtocolRequestTypeEnum.RESTXML), response8.getResponseObject());
