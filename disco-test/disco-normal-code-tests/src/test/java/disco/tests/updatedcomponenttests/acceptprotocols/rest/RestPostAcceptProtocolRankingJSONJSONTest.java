...
/**
 * Ensure that when a Rest JSON Post operation is performed on Disco, with JSON the highest ranked response protocol, the response is JSON
 */
public class RestPostAcceptProtocolRankingJSONJSONTest {
    ...
    public void doTest() throws Exception {
        ...
        AssertionUtils.multiAssertEquals(convertResponseToRestTypes11.get(DiscoMessageProtocolRequestTypeEnum.RESTJSON), getResponseObjectsByEnum12.getResponseObject());
