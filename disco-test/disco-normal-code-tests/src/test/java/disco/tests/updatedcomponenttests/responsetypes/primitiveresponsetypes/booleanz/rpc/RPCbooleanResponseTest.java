...
package uk.co.exemel.disco.tests.updatedcomponenttests.responsetypes.primitiveresponsetypes.booleanz.rpc;
...
/**
 * Test that the Disco service allows to use boolean primitive type in the response (Batched JSON)
 */
public class RPCbooleanResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager.verifyRequestLogEntriesAfterDate(timeStamp, new RequestLogRequirement("2.8", "boolSimpleTypeEcho"),new RequestLogRequirement("2.8", "boolSimpleTypeEcho") );
