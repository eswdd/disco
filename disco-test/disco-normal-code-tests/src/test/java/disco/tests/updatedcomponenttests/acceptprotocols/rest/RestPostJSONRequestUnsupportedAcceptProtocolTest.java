...
/**
 * Ensure that when a Rest JSON Post is performed on Disco, specifying an unsupported response protocol, the correct error response is generated
 */
public class RestPostJSONRequestUnsupportedAcceptProtocolTest {
    ...
    public void doTest() throws Exception {
        ...
        discoManager2.convertResponseToRestTypes(createAsDocument12, getNewHttpCallBean2);
