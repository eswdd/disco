...
/**
 * Test that the Disco service throws a correct error when invalid value is passed to  i32 primitive type parameter (REST)
 */
public class Resti32InvalidResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyAccessLogEntriesAfterDate(timeStamp, new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/i32Echo", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/i32Echo", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/i32Echo", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/i32Echo", "BadRequest") );
    }
