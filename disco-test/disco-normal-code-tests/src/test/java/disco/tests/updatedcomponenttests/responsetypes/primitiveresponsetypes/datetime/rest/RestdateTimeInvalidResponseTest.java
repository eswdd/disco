...
/**
 * Test that the Disco service throws a correct error when invalid value is passed to  dateTime primitive type parameter (REST)
 */
public class RestdateTimeInvalidResponseTest {
    ...
    public void doTest() throws Exception {
        ...
        DiscoManager.verifyAccessLogEntriesAfterDate(timeStamp, new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/dateTimeEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/dateTimeEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/dateTimeEcho", "BadRequest"),new AccessLogRequirement("87.248.113.14", "/discoBaseline/v2/dateTimeEcho", "BadRequest") );
    }
