...
/**
 * Ensure that Disco can handle the dateTimeMap data type in the post body of an XML request containing dates specifying the UTC timezone
 */
public class RestPostRequestTypesDateTimeMapXMLZOffset2Test {
    ...
    public void doTest() throws Exception {
        ...
        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2009, (int) 2, (int) 2, (int) 11, (int) 50, (int) 0, (int) 435);
