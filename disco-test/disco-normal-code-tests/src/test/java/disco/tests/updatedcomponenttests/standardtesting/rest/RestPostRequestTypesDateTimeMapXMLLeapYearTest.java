...
/**
 * Ensure that Disco can handle the dateTimeMap data type in the post body of an XML request containing a date set to 29th Feb on a leap year
 */
public class RestPostRequestTypesDateTimeMapXMLLeapYearTest {
    ...
    public void doTest() throws Exception {
        ...
        String date1 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2012, (int) 2, (int) 29, (int) 13, (int) 50, (int) 0, (int) 0);
        // Create a date time object expected to be in the response object

        String date2 = TimingHelpers.convertUTCDateTimeToDiscoFormat((int) 2012, (int) 2, (int) 29, (int) 14, (int) 50, (int) 0, (int) 0);
