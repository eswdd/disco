...
/**
 * Ensure that when an operation with a mandatory query param is performed against disco via a disco client with a blank query param, the request is sent and the response is handled correctly
 */
