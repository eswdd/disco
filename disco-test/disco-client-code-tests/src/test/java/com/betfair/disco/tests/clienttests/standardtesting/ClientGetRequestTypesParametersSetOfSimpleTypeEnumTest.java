...
/**
 * Ensure that when a simpleEnumSet is passed to disco via a disco client the request is sent and the response is handled correctly
 */
public class ClientGetRequestTypesParametersSetOfSimpleTypeEnumTest {
    ...
    public void doTest(DiscoClientWrapper.TransportType tt) throws Exception {
        ...
        Set<SimpleEnum> querySet = discoClientResponseTypeUtils2.buildEnumSet("FOOFOO,BARBAR,FOOFOO");
        // Build set to pass as parameter
        DiscoClientResponseTypeUtils discoClientResponseTypeUtils3 = new DiscoClientResponseTypeUtils();
        Set<SimpleEnum> headerSet = discoClientResponseTypeUtils3.buildEnumSet("FOO,FOOBAR,BARFOO");
