...
/**
 * Ensure that when multiple escaped characters are passed in a header parameter to disco via a disco client the request is sent and the response is handled correctly
 */
