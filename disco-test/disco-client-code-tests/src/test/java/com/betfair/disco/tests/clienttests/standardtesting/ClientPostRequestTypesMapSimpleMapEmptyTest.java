...
/**
 * Ensure that when an empty SimpleMap is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesMapSimpleMapEmptyTest {
    ...
    public void doTest(DiscoClientWrapper.TransportType tt) throws Exception {
        ...
        Map<String, String> simpleMap = discoClientResponseTypeUtils2.buildMap("", "");
