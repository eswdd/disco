...
/**
 * Ensure that when a SimpleMap object with a large null value is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesMapSimpleMapNullValueTest {
    ...
    public void doTest(DiscoClientWrapper.TransportType tt) throws Exception {
        ...
        Map<String, String> simpleMap = discoClientResponseTypeUtils2.buildMap("aaa,bbb,ccc,ddd", "Value for aaa,Value for bbb,Value for ccc");
