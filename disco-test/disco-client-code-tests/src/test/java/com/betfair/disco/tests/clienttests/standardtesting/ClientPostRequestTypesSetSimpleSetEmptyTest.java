...
/**
 * Ensure that when an empty SimpleSet object is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesSetSimpleSetEmptyTest {
    ...
    public void doTest(DiscoClientWrapper.TransportType tt) throws Exception {
        ...
        Set<String> inputSet = discoClientResponseTypeUtils2.buildSet("");
