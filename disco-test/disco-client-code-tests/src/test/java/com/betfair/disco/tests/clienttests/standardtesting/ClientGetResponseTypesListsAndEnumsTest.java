...
/**
 * Ensure that a request that returns a response containing both lists and enums can be performed against disco via a disco client and the response is handled correctly
 */
