...
/**
 * Ensure that when a SimpleMap object with a large volume of entries is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
