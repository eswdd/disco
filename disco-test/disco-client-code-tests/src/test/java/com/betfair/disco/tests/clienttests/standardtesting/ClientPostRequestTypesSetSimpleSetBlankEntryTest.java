...
/**
 * Ensure that when a SimpleSet object with a blank entry is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesSetSimpleSetBlankEntryTest {
    ...
    public void doTest(DiscoClientWrapper.TransportType tt) throws Exception {
        ...
        Set<String> inputSet = discoClientResponseTypeUtils2.buildSet("aaaString,,cccString,dddString");
