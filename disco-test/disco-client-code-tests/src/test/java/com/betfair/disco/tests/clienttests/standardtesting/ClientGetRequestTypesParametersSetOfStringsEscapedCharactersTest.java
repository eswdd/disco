...
/**
 * Ensure that when a stringSet with escaped characters is passed to disco via a disco client the request is sent and the response is handled correctly
 */
public class ClientGetRequestTypesParametersSetOfStringsEscapedCharactersTest {
    ...
    public void doTest(DiscoClientWrapper.TransportType tt) throws Exception {
        ...
        Set<String> querySet = discoClientResponseTypeUtils2.buildSet("a query1,:query2,this & that is 100%");
        // Build set to pass as parameter
        DiscoClientResponseTypeUtils discoClientResponseTypeUtils3 = new DiscoClientResponseTypeUtils();
        Set<String> headerSet = discoClientResponseTypeUtils3.buildSet("a header1,:header2,this & that is 100%");
