...
/**
 * Ensure that when a Double object (with value Infinity) is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
