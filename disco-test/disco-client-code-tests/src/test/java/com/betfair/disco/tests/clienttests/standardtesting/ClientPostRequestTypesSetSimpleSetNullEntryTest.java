...
/**
 * Ensure that when a SimpleSet object with a null entry is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
