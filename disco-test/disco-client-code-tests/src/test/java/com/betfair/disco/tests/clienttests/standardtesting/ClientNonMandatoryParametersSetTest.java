...
/**
 * Ensure that when a request is made to disco via a disco client, with all non mandatory parameters set, the request is sent and the response is handled correctly
 */
