...
/**
 * Ensure that when a List with a null entry is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
