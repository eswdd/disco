...
/**
 * Ensure that when an operation, which takes standard and enum header and query parameters, is performed against disco via a disco client the request is sent and the response is handled correctly
 */
