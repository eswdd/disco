...
/**
 * Ensure that when a stringSimpleTypeEcho operation is performed against disco via a disco client the request is sent and the response is handled correctly
 */
