...
/**
 * Ensure that when a request containing HTML in a body parameter is made to disco via a disco client the request is sent and the response is handled correctly
 */
