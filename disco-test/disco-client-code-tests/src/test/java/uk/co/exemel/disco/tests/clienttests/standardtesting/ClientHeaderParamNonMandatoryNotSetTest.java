...
/**
 * Ensure that when a request is made to disco via a disco client, with some non mandatory header parameter not set, the request is sent and the response is handled correctly
 */
