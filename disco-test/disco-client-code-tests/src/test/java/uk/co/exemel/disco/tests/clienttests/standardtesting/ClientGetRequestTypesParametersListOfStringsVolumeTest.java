...
/**
 * Ensure that when a stringList with a large volume of entries is passed to disco via a disco client the request is sent and the response is handled correctly
 */
