...
/**
 * Ensure that when a (Zeroe) SimpleType Integer object is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
