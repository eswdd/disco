...
/**
 * Ensure that when multiple escaped characters are passed in a query parameter to disco via a disco client the request is sent and the response is handled correctly
 */
