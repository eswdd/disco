...
/**
 * Ensure that when a SimpleMap object with a blank key is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesMapSimpleMapBlankKeyTest {
    ...
    public void doTest(DiscoClientWrapper.TransportType tt) throws Exception {
        ...
        Map<String, String> simpleMap = discoClientResponseTypeUtils2.buildMap(",aaa,ccc,ddd", "Blank Key,Value for aaa,Value for ccc,Value for ddd");
