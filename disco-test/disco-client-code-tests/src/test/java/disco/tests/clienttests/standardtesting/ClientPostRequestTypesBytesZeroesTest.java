...
/**
 * Ensure that when a (Zeroe) Byte object is passed in parameters to disco via a disco client, the request is sent and the response is handled correctly
 */
public class ClientPostRequestTypesBytesZeroesTest {
    ...
    public void doTest(DiscoClientWrapper.TransportType tt) throws Exception {
        ...
        BodyParamByteObject bodyParam = discoClientResponseTypeUtils2.buildByteBodyParamObject("0,1,2,3,4,5");
