...
/**
 * Ensure that when a stringSet with a blank entry is passed to disco via a disco client the request is sent and the response is handled correctly
 */
public class ClientGetRequestTypesParametersSetOfStringsBlankEntryTest {
    ...
    public void doTest(DiscoClientWrapper.TransportType tt) throws Exception {
        ...
        Set<String> querySet = discoClientResponseTypeUtils2.buildSet("query1,queryTwo,,query4");
        // Build set to pass as parameter
        DiscoClientResponseTypeUtils discoClientResponseTypeUtils3 = new DiscoClientResponseTypeUtils();
        Set<String> headerSet = discoClientResponseTypeUtils3.buildSet("header1,headerTwo,,header4");
