...
/**
 * Ensure that when a testParameterStylesQA operation with escaped character & as a parameter is performed against disco via a disco client the request is sent and the response is handled correctly
 */
